...
def stax_bip85_bip39(backend):
    ...
    backend.finger_touch(124, 600, 1)
...
def test_bip85_bip39(firmware, backend, navigator, set_seed):
    if firmware.device == "nanos":
        ...
        stax_bip85_bip39(backend)
    elif firmware.device == "flex":
        flex_bip85_bip39(backend)
