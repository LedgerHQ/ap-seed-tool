...
def stax_bip85_pwd_base64(backend):
    ...
    backend.finger_touch(124, 520, 1)
...
def flex_bip85_pwd_base64(backend):
    backend.wait_for_text_on_screen("Seed Tool", 10)
...
def test_bip85_pwd_base64(firmware, backend, navigator, set_seed):
    if firmware.device == "nanos":
        ...
        stax_bip85_pwd_base64(backend)
    elif firmware.device == "flex":
        flex_bip85_pwd_base64(backend)
